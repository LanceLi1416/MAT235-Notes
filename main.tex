...
\begin{enumerate}
    ...
    Plugging back into the PDE, we get $\begin{aligned}[t]
        \left( \frac{\partial u}{\partial s} + \frac{\partial u}{\partial t} \right) + \left( \frac{\partial u}{\partial s} - \frac{\partial u}{\partial t} \right) & = 1 \\
        \frac{\partial u}{\partial s} & = \frac{1}{2} \\
        \int \frac{\partial u}{\partial s} \,ds & = \int \frac{1}{s} \,ds \\
        u & = \frac{1}{2} s + f(t)
    \end{aligned}$
