...
\begin{enumerate}
    ...
    Plugging back into the PDE, we get $\begin{aligned}[t]
        ...
        \frac{\partial u}{\partial s} & = \frac{e^{x+2y}{2} - \frac{u}{2} \\
        \int \frac{\partial u}{\partial s} \,ds &= \int \frac{e^{x+2y}{2} - \frac{u}{2} \,ds \\
        \int \frac{\partial u}{\partial s} \,ds &= \int \frac{e^{x+2y}{2} \,ds - \int \frac{u}{2} \,ds \\
        u &= \frac{e^{x+2y}{2} u - \int \frac{u}{2} \,ds 
    \end{aligned}$
